...
export default async function EmployerSanctionsDataFetcher({
  searchParamsPromise,
}: {
    ...
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <header className="mb-8">
        ...
        <p className="mt-2 text-sm text-slate-500 font-medium">
          Dossier disciplinaire de votre alternant :{" "}
      ...
      <SanctionsPortalList
        ...
        emptyDescription="L'alternant ne fait l'objet d'aucune sanction ou avertissement en cours au CFA."
      />
    </div>
  );
}
